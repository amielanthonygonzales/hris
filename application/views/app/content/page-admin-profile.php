...
<script type="text/javascript">
	...
	pageAdminProfile.init = function(selector, callback){
	    ...
	    pageAdminProfile.elem.find('.engagement-date').keydown(function(e){
			if(e.which == 9){
				return true;
			}else{
				return false;
		...
		pageAdminProfile.elem.find('.engagement-date').on("contextmenu",function(){
	       return false;
	    }); 

	    pageAdminProfile.elem.find('.remarks-date').keydown(function(e){
			if(e.which == 9){
				return true;
			}else{
				return false;
		...
		pageAdminProfile.elem.find('.remarks-date').on("contextmenu",function(){
	       return false;
	    }); 
