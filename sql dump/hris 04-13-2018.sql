...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2018 at 04:39 AM
...
(1, '11111', '1111', 'Toy Story', '{"room_no":"126","bldg_name":"gdgdg","house":"gdgd","street_name":"gdgd","subdivision":"ggdg","barangay":"dgdg","city":"dggdg","province":"gddgd","zip_code":"121212"}', '121205', '{"company_tel_no":"1121221","company_cel_no":"212122"}', 'dgsdg@gvdkjsdsf', 'Juan Dela Cruz', 'HR Head');
...
('41297', 2, 'amiel', 'dela cruz', 'gonzales', '', '0000-00-00', '', 0, 'amiel', '$2y$10$p3jVBnvKlbreBS7rRJnGj.1kowWLS7SWs6kPEBRxs0/SLuB91CAN6', 'admin', 0),
...
INSERT INTO `pag_ibig` (`pagibig_id`, `pagibig_emp_id`, `pagibig_mid_no`, `pagibig_no`, `pagibig_ee_share`, `pagibig_er_share`, `pagibig_mem_prog`, `monthly_compen`, `pagibig_remarks`, `pagibig_deleted`) VALUES
(1, '1235', '0', '0', 0, 0, '', '', '', 1),
(2, '9864', '0', '0', 0, 0, '', '', '', 1),
...
--
ALTER TABLE `pag_ibig`
  MODIFY `pagibig_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;
--
-- AUTO_INCREMENT for table `sss`
--
ALTER TABLE `sss`
  MODIFY `sss_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;
